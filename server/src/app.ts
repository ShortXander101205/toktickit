...
// ---------------------------------------------------------------------------
// Lab 3 — Feature 12 Authentication Routes
// ---------------------------------------------------------------------------
...
app.use("/api/v1/tickets", requirePasswordChanged, ticketsRouter);
app.use("/api/v1/attachments", requirePasswordChanged, attachmentsRouter);
