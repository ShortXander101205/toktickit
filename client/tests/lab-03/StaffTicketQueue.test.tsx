...
import { StaffTicketSummaryDTO, StaffQueueResponseDTO } from "../../src/types/index.js";
...
describe("Issue 13: IT Staff Ticket Queue & List Queries UI", () => {
  beforeEach(() => {
    vi.restoreAllMocks();
  ...
  it("AC-13.1: renders 8-column desktop table with complete ticket metadata", async () => {
    ...
    // Ticket 2 has null owner -> Unassigned badge
